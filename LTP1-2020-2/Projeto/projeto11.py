...
Sim = True
while resposta == 'Sim':
  print('ID 1 gera uma operação de recebimento de R$ 250.00 para o ID2')
  ...
  if usuario == 'ID2':
    ...
    print('Usuário ou senha incorreta')
    resposta = input('Deseja tentar novamente? (Sim ou Não) ')
  print('ID 1 gera uma operação de recebimento de R$ 250.00 para o ID3')
  usuario = input('Informe o seu ID: ')
  senha = input('Informe a sua senha: ')
  email = input('Informe o seu e-mail: ')
  if usuario == 'ID3':
  ...
  if usuario == 'ID2':
    if senha == senha_ID2:
      ...
      print('Usuário ou senha incorreta')
      resposta = input('Deseja tentar novamente? (Sim ou Não) ')
  print('ID 2 gera uma operação de recebimento de R$ 1000.00 para o ID3')
  usuario = input('Informe o seu ID: ')
  senha = input('Informe a sua senha: ')
  email = input('Informe o seu e-mail: ')
  if usuario == 'ID3':
